...
write.csv(sigfgseaRes, file = "Data/fgsea_Das_Pathways.csv")
write.csv(sigfgseaResCollapsed, file = "Data/fgsea_Das_Pathways_Collapsed.csv")


# Save the object that's later loaded in to calculate metagenes.
saveRDS(ensginPathsfgsea, file = "Data/Ensembl_ID_in_Paths_fgsea.Rds")
```
