...
synergy.frame <- read.csv("data/raw/Normalised_Viability_Data.csv")
...
### Convert any missing response values to NA, for clarity
```{r}
synergy.frame <- synergy.frame %>%
...
saveWorkbook(wb, file = paste0(synergy.type, "_", "4_output/NCI-N87_response_and_synergy.xlsx"), overwrite = T)
