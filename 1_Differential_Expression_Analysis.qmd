...
# What types of data are included in the processed GDSC2 dataset?
...
group <- cut(
  sort_dasatinib_GDSC2$MEAN_LN_IC50,
  breaks = quantile(sort_dasatinib_GDSC2$MEAN_LN_IC50, probs = c(0, 1/3, 2/3, 1), na.rm = TRUE),
...
ggplot(sort_dasatinib_GDSC2, aes(x = group, y = MEAN_LN_IC50)) +
  geom_boxplot() +
  labs(title = "MEAN_LN_IC50 Distribution by Group",
       x = "Group", y = "MEAN_LN_IC50") +
  theme_minimal()
...
# Plot fold change in MEAN_LN_IC50 against adjusted p-value.
