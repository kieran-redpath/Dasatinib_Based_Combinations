---
title: "Dasatinib Pathway Analysis - Negative Control"
...
## Summary
* This is identical to 1_Dasatinib_Pathway_Analysis, except that it randomises the names of genes, to work as a negative control for pathway enrichment analysis. Unsurprisingly, there's only a single pathway with an adj-P < 1.
...
# Create a backup that stores gene names in their true order
ccleExpDataReal <- ccleExpData
# Create a randomised list of the gene names
randgenes <- sample(rownames(ccleExpData))
# Reassign these to the matrix
rownames(ccleExpData) <- randgenes
...
write.csv(SiggoseqPathways, file = "Data/goseq_Das_Pathways_negative_control.csv")
```
